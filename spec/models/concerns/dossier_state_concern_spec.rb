...
RSpec.describe DossierStateConcern do
  ...
  describe '#passer_automatiquement_en_instruction!' do
    context 'via a declarative procedure' do
      ...
      include_examples 'notifies the usager', 'en_construction' # the combined declarative email
  ...
  describe 'declarative combined email' do
    ...
    context 'when the procedure is not declarative' do
      ...
      it 'sends the proof of receipt alone' do
    ...
    context 'when the procedure is declarative en instruction' do
      ...
      it 'sends the combined email alone' do
        expect { deposer_dossier }.to change { deliveries.size }.by(1)
      ...
      context 'and it stays on the legacy emails' do
        ...
        it 'sends both historical emails' do
          expect { deposer_dossier }.to change { deliveries.size }.by(2)
      ...
      context 'and a dossier put back en construction is auto archived' do
        ...
        it 'sends the passage en instruction email, not a second proof of receipt' do
    ...
    context 'when the procedure is declarative accepte' do
      ...
      it 'sends the combined email alone, with the decision date substituted' do
        expect { deposer_dossier }.to change { deliveries.size }.by(1)
      ...
      context 'and a dossier left en construction is auto archived' do
        ...
        it 'sends the passage en instruction email, the decision not being taken' do
          travel_to(2.days.from_now)
    ...
    context 'when a non declarative procedure uses the accusé de lecture' do
      ...
      it 'still sends the accusé de lecture' do

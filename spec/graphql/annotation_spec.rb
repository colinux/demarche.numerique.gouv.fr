...
RSpec.describe Mutations::DossierModifierAnnotations, type: :graphql do
  ...
  describe 'dossierModifierAnnotationText' do
    ...
    context 'with rows' do
      let(:annotation) { champs_private.find(&:repetition?).rows.first.flat_children.first }
      let(:other_annotation) { champs_private.find(&:repetition?).rows.second.flat_children.first }
  ...
  describe 'dossierModifierAnnotationDecimalNumber' do
    ...
    context 'with rows' do
      let(:annotation) { champs_private.find(&:repetition?).rows.first.flat_children.find(&:decimal_number?) }
      let(:other_annotation) { champs_private.find(&:repetition?).rows.second.flat_children.find(&:decimal_number?) }
